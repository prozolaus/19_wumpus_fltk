CC=g++  
CFLAG = -std=c++14
EXE_NAME = hunt_the_wumpus

all: main
	@echo "Done."


main: Graph.o Window.o GUI.o Simple_window.o main.o wumpus.o
	$(CC) $(CFLAG) -L/usr/local/lib Graph.o Window.o GUI.o Simple_window.o main.o wumpus.o `fltk-config --ldflags --use-images` -o $(EXE_NAME)
...
wumpus.o: wumpus.h wumpus.cpp Point.h std_lib_facilities.h
	$(CC) $(CFLAG) -I/usr/local/include -c wumpus.cpp
